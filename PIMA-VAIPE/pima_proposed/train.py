...
def train_epoch(model, dataloader, optimizer, device, vision_model='vit'):
    model.train()
    total_loss = 0
    total_match_loss = 0
    total_cls_loss = 0
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        t_loss, m_loss, c_loss, d_loss = train_epoch(model, train_loader, optimizer, device, vision_model=args.vision_model)
